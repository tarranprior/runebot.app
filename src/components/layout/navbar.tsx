...
import { Menu, X, BookOpen, Github, ArrowUpRight, Shield } from "lucide-react";
                ...
                <div className="flex w-full items-center justify-between gap-4">
                  ...
                  <div className="ml-auto hidden items-center gap-2 md:flex">
                    ...
                    <Link
                      ...
                      title="Admin"
                      aria-label="Admin"
                      className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-surface-border bg-surface/70 text-foreground transition hover:bg-surface"
                    >
